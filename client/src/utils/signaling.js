...
// --- DIAGNOSTIC RE-TEST: Force only host candidates ---
const finalIceServers = []; 
console.warn("DIAGNOSTIC MODE (RE-TEST): ICE_SERVERS is empty. Relying on host candidates only.");
// --- END DIAGNOSTIC RE-TEST ---
...
console.log("ICE Servers Configured (Diagnostic Re-Test):", finalIceServers); // Log the actual config
